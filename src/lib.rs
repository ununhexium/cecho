...
fn spec_to_ansi(inputs: &Vec<String>, specs: Vec<Part>) -> Result<String, String> {
    let mut position = 0;
...
impl Part {
    ...
    pub const fn positional(color: ColorPair) -> Self {
...
#[cfg(test)]
mod tests {
    use crate::{cecho, Color, ColorPair, parse_color, parse_format_in_default_mode, parse_spec, Part, spec_to_ansi, Text};
    use crate::Part::{Literal, Specification};
